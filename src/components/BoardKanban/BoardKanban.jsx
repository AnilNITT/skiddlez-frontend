        ...
        <div className = "project-section1">
          <ul className = "project-section1-top">
            ...
            <ProjectsPopup projectsList = {allProjects}  project={{
                  ...
                  onDelete={onDelete}
                  id = 'projects-popup'>
                    <button className = 'glass-btn btn-max project-btn lg' type = 'button'>Projects<i className="fas fa-sort-down"/>
                  <span/>
                  <span/>
                  <span/>
                  <span/></button>
            ...
            <li>
            <button className = 'glass-btn btn-max disabled lg' type = 'button'><i className="far fa-sticky-note"/>
                  <span/>
                  <span/>
                  <span/>
                  <span/></button>
            ...
            <li>
              ...
              <CreateActions
                ...
                id = "board-activity"
                >
                <button className = 'glass-btn btn-max project-btn lg' type = 'button'>Create<i className="fas fa-sort-down"/>
                  <span/>
                  <span/>
                  <span/>
                  <span/></button>
            ...
            <li>
              <Filter
                ...
                id = "filter-modal"
              >
                <button type='button' className = 'glass-btn btn-max project-btn lg'>Filter<i className="fas fa-sort-down"/>
                <span/>
                  <span/>
                  <span/>
                  <span/></button>
            ...
            <ul className='project-section1-bottom'>
              ...
              <li>
                <BoardsContainer id = 'boards-popup'>
                  <button className = 'glass-btn btn-max boards-btn project-btn lg' type='button'>Boards<i className="fas fa-sort-down"/>
                    <span/>
                    <span/>
                    <span/>
                    <span/></button>
